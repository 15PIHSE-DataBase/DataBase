...
int keys = 0;		//если такая переменная есть в stdafx, то надо удалить её!!!
int number = 0;		//сохранение кол-ва освободившихся ключей
int* freek = NULL;	//массив освободившихся ключей
